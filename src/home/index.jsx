...
<h2 className="text-md text-gray-500">Create a resume with help of AI in just 3 simplar easy step</h2>
...
<div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
      ...
      >
       <AtomIcon className='h-8 w-8'/>
        ...
        <h2 className="mt-4 text-xl font-bold text-black">Login to the platform and Fill the Details</h2>
      ...
      <Edit className='h-8 w-8'/>
        ...
        <h2 className="mt-4 text-xl font-bold text-black">Take a help of AI to Edit your form </h2>
      ...
      <Share2 className='h-8 w-8' />
        ...
        <h2 className="mt-4 text-xl font-bold text-black">Download and Share the Resume</h2>
